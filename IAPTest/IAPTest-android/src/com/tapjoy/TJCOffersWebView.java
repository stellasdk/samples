	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (extras != null)
		{
			...
			else
			{
				...
				{
					// Is this device on wifi?  Then show all videos.
					if (TapjoyConnectCore.getConnectionType().equals("wifi"))
					{
						// all_videos=true
						urlParams += "&" + TapjoyConstants.TJC_ALL_VIDEO_OFFERS + "=" + "true";
					}
					// Show only cached videos.
					else
					{
